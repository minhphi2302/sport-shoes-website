...
<head>
    ...
    <title>
        <?= htmlspecialchars($title ?? 'ANTA Bán Giày Thể Thao') ?>
    </title>
    <!-- Meta SEO -->
    <meta name="description"
        content="<?= htmlspecialchars($metaDescription ?? 'Cửa hàng giày thể thao uy tín, chính hãng, giá tốt nhất.') ?>">
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="top-bar" id="topAnnouncementBar">
        <div class="container position-relative text-center d-flex justify-content-center align-items-center py-1">
            <a href="<?= base_url('products') ?>" class="announcement-text fw-bold">
                <i class="fa-solid fa-truck-fast me-2 text-red"></i> MIỄN PHÍ GIAO HÀNG TOÀN QUỐC CHO ĐƠN HÀNG TỪ
                500.000VNĐ
            </a>
    ...
    <nav class="navbar navbar-expand-lg navbar-main sticky-top">
        ...
        <div class="container">
            ...
            <a class="navbar-brand py-0 me-4 d-flex align-items-center" href="<?= base_url('/') ?>">
                <img src="<?= base_url('image/logo.webp') ?>" alt="Sport Shoes Logo"
                    style="height: 46px; max-height: 48px; width: auto; object-fit: contain;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown dropdown-hover">
                        <a class="nav-link nav-link-custom no-red-hover dropdown-toggle <?= $isProducts ? 'active' : '' ?>"
                        ...
                        <ul class="dropdown-menu custom-dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="<?= base_url('products?sort=newest') ?>">Sản phẩm mới
                                    nhất</a></li>
                            <li><a class="dropdown-item" href="<?= base_url('products?sort=bestseller') ?>">Bán chạy
                                    nhất</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown dropdown-hover">
                        <a class="nav-link nav-link-custom dropdown-toggle <?= $isCategory ? 'active' : '' ?>"
                            href="<?= base_url('products') ?>">
                    ...
                    <li class="nav-item dropdown dropdown-hover">
                        <a class="nav-link nav-link-custom dropdown-toggle <?= $isBrand ? 'active' : '' ?>"
                            href="<?= base_url('products') ?>">
                ...
                <!-- Search Form -->
                <form class="d-flex me-3 my-2 my-lg-0 search-box-group" action="<?= base_url('products') ?>"
                    method="GET">
