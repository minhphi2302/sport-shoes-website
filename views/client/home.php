    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            ...
            <div class="carousel-caption carousel-caption-custom container">
                ...
                <div>
                    <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/products" class="btn btn-red me-3"><i
                            class="fa-solid fa-cart-shopping me-2"></i> Mua Ngay</a>
                    <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/products?brand_id=1" class="btn btn-outline-light"><i
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption carousel-caption-custom container">
                ...
                <div>
                    <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/products" class="btn btn-red me-3"><i
                            class="fa-solid fa-bolt me-2"></i> Khám Phá</a>
                </div>
            </div>
        </div>
        <!-- Slide 3 -->
                ...
                <?php foreach ($brands as $brand): ?>
                    <div class="col-6 col-md-4 col-lg-2">
                        <a href="<?= base_url('products?brand_id=' . $brand['brand_id']) ?>" class="brand-card">
                            ...
                            ?>
                            <img src="<?= base_url(htmlspecialchars($logo)) ?>" alt="<?= htmlspecialchars($brand['name']) ?>"
                            ...
                            <div class="product-card">
                                <div class="product-img-wrapper">
                                    ...
                                    <?php if (($dp['quantity'] ?? 50) > 0): ?>
                                        <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/cart/add/<?= $dp['id'] ?>" class="btn-cart-hover"
                                            title="Thêm vào giỏ">
                                            <span class="cart-text">Thêm vào giỏ</span>
                                            <span class="cart-icon-wrapper">
                                                <svg class="custom-bag-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
...
<section class="py-5 bg-dark text-white my-4 position-relative overflow-hidden" style="--promo-color: #ff006a;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <span class="badge fs-6 mb-2 text-white border-0" style="background-color: var(--promo-color);">ƯU ĐÃI
                    KHỦNG THÁNG NÀY</span>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-9 text-center">
                ...
                <p class="mb-4 text-secondary" style="line-height: 1.8; font-size: 1.05rem; text-align: justify;">
                    Khám phá những đôi giày thể thao hiệu năng cao, ứng dụng công nghệ tiên tiến nhất để bạn chinh phục
                    mọi giới hạn. Dù bạn là người đam mê chạy bộ, yêu thích bóng rổ hay đơn giản là theo đuổi lối sống
                    năng động, ANTA Store luôn là điểm đến lý tưởng. Chúng tôi đồng hành để bạn tập luyện bền bỉ hơn, di
                    chuyển linh hoạt hơn với những sản phẩm luôn theo kịp từng bước chân của bạn.
                </p>
                ...
                <p class="mb-5 text-secondary" style="line-height: 1.8; font-size: 1.05rem; text-align: justify;">
                    ...
                    cách và bứt phá giới hạn bản thân. Mỗi đôi giày đều được chế tác tỉ mỉ, chú trọng tuyệt đối vào độ
                    êm ái, độ bền và chi tiết thiết kế. Dù bạn chơi môn thể thao nào, ANTA luôn sẵn sàng đồng hành –
                    giúp bạn tự tin tỏa sáng và từng bước vươn tới đỉnh cao.
                </p>
