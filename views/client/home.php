                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="card h-100 rounded-1 border promo-card overflow-hidden bg-white product-card">
                                        ...
                                        <div class="position-relative">
                                            <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/products/<?= $product['product_id'] ?>" class="text-decoration-none d-block">
                                            ...
                                            <div class="product-center-action">
                                                <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/products/<?= $product['product_id'] ?>" class="search-icon-btn" title="Xem chi tiết"><i class="fa-solid fa-magnifying-glass"></i></a>
                                            </div>
                                        ...
                                        <div class="card-body px-2 py-3 text-start">
                                            <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/products/<?= $product['product_id'] ?>" class="text-dark text-decoration-none fw-semibold d-block mb-1" style="font-size: 0.95rem; line-height: 1.4;"><?= htmlspecialchars($product['name']) ?></a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card">
                            <div class="product-img-wrapper">
                                ...
                                <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/products/<?= $dp['id'] ?>" class="d-block position-absolute w-100 h-100" style="top:0; left:0; z-index: 5;">
                                    <img src="<?= $dp['img'] ?>" alt="<?= $dp['name'] ?>">
                                </a>
                                <div class="product-actions-overlay">
                                    <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/products/<?= $dp['id'] ?>" class="btn-action-icon" title="Xem chi tiết"><i class="fa-solid fa-magnifying-glass"></i></a>
                                </div>
                            ...
                            <div class="product-body">
                                ...
                                <a href="<?= ($_ENV['APP_URL'] ?? '') ?>/products/<?= $dp['id'] ?>" class="product-title mb-1"><?= $dp['name'] ?></a>
                                <?php if (!empty($dp['sku'])): ?>
