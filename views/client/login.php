    ...
    <div class="container d-flex justify-content-center">
        <div class="auth-card" style="max-width: 600px; width: 100%; padding: 2rem;">
            ...
            <div class="text-center mb-4 pb-2">
                ...
                <p class="text-dark mb-0">Bạn chưa có tài khoản ? <a
                        href="<?= ($_ENV['APP_URL'] ?? '') ?>/register<?= $redirectParam ?>"
                        class="fw-bold text-decoration-none" style="color: #d9534f; transition: color 0.2s;"
                        onmouseover="this.style.color='#c9302c';" onmouseout="this.style.color='#d9534f';">Đăng ký tại
                        đây</a></p>
            </div>
            ...
            <form action="<?= ($_ENV['APP_URL'] ?? '') ?>/login<?= $redirectParam ?>" method="POST">
                ...
                <div class="mb-2">
                    ...
                    <input type="password" name="password" class="form-control rounded-1 py-2" placeholder="Mật khẩu"
                        required>
                </div>

                <div class="mb-4">
                    <span class="text-dark">Quên mật khẩu? Nhấn vào <a href="#"
                            class="text-primary text-decoration-none">đây</a></span>
                </div>
                ...
                <div class="d-flex justify-content-center">
                    <a href="#" class="btn text-white px-4 py-2 rounded-1 fw-normal"
                        style="background-color: #d9534f; font-size: 1.05rem;">
