    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="card border-0 shadow-sm rounded-4 p-5">
                ...
                <p class="mb-5">
                    Chúng tôi sẽ sớm liên hệ với bạn để xác nhận đơn hàng và thông báo thời gian giao hàng dự kiến. Bạn
                    có thể theo dõi trạng thái đơn hàng trong phần quản lý tài khoản.
                </p>
